...
"[project]/src/app/teacher/test/[id]/results/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ResultsPage({ params }) {
    ...
    const fetchResults = async ()=>{
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`/api/tests/${id}/results`);
            setData(res.data);
        } catch (err) {
    ...
    const handleExportCSV = ()=>{
        if (!data) return;
        const headers = [
            'Name,USN,Department,Semester,Score,Total Marks,Submitted At'
        ];
        const rows = data.results.map((r)=>`"${r.studentName}","${r.usn}","${r.department}","${r.semester}","${r.score}","${r.totalMarks}","${new Date(r.submittedAt).toLocaleString()}"`);
    ...
    if (loading) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        fileName: "[project]/src/app/teacher/test/[id]/results/page.tsx",
        lineNumber: 48,
        columnNumber: 25
    }, this);
    if (!data) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "p-8",
        children: "Test info not found"
    }, void 0, false, {
        fileName: "[project]/src/app/teacher/test/[id]/results/page.tsx",
        lineNumber: 49,
        columnNumber: 23
    }, this);
    const filteredResults = data.results.filter((r)=>r.studentName.toLowerCase().includes(filter.toLowerCase()) || r.usn.toLowerCase().includes(filter.toLowerCase()));
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("table", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("thead", {
                                        className: "bg-gray-50 dark:bg-gray-800/50 text-gray-500 text-sm",
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                                        ...
                                        children: [
                                            filteredResults.map((r)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                                    ...
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                            className: "p-4 text-sm font-mono text-gray-500",
                                                            children: r.usn
                                                        }, void 0, false, {
                                                            fileName: "[project]/src/app/teacher/test/[id]/results/page.tsx",
                                                            lineNumber: 102,
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                            className: "p-4 font-bold text-blue-600",
                                                            children: [
                                                                r.score,
                                                                " / ",
                                                                r.totalMarks
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                            ...
                                                            children: new Date(r.submittedAt).toLocaleString()
                                                        }, void 0, false, {
                                                            fileName: "[project]/src/app/teacher/test/[id]/results/page.tsx",
                                                            lineNumber: 105,
                                                            columnNumber: 41
                                            ...
                                            filteredResults.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
...
_s(ResultsPage, "0OVdY0JJIAz3kDtS7RTYSxNARQs=");
_c = ResultsPage;
var _c;
...
//# sourceMappingURL=src_c5e507ab._.js.map