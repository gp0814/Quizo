...
function LoginPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        setError('');
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/api/auth/login', formData);
...
_s(LoginPage, "eN42g1Ky6jOnm5x7l8yqbim11Yw=", false, function() {
    return [
...
//# sourceMappingURL=src_24e6b460._.js.map