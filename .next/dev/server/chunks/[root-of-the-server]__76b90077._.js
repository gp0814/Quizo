...
"[project]/src/app/api/tests/[id]/start/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req, { params }) {
    try {
        ...
        const test = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Test$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findById(id).select('-questions.correctAnswer');
        if (!test) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        const existingResult = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Result$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOne({
            testId: id,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__76b90077._.js.map