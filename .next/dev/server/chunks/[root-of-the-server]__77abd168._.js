...
"[project]/src/app/api/tests/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req, { params }) {
    try {
        ...
        const test = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Test$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOne({
            _id: id,
...
async function PUT(req, { params }) {
    try {
        ...
        const test = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Test$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOneAndUpdate({
            _id: id,
            createdBy: user.userId
        }, {
            $set: updates
...
async function DELETE(req, { params }) {
    try {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])();
        const { id } = await params;
        const test = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Test$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOneAndDelete({
            _id: id,
            createdBy: user.userId
        });
        if (!test) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__77abd168._.js.map