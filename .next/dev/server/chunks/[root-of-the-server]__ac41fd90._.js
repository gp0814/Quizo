...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$User$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/models/User.ts [app-route] (ecmascript)"); // We need to fix the import alias or move models to src
...
async function POST(req) {
    try {
        ...
        if (role === 'student' && (!usn || !semester)) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'USN and Semester are required for students'
            }, {
                status: 400
            });
        }
        ...
        const newUser = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$User$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].create({
            name,
            email,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ac41fd90._.js.map