...
"[project]/src/models/Result.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const ResultSchema = new __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["Schema"]({
    ...
    answers: [
        {
            questionId: __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["Schema"].Types.ObjectId,
            questionText: String,
...
const Result = __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].models.Result || __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].model('Result', ResultSchema);
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Result$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/models/Result.ts [app-route] (ecmascript)");
...
async function POST(req, { params }) {
    try {
        ...
        const test = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Test$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findById(testId);
        if (!test) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        const student = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$User$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findById(userData.userId);
        let score = 0;
        ...
        const processedAnswers = test.questions.map((q)=>{
            ...
            const studentAnsObj = answers.find((a)=>a.questionId === q._id.toString());
        ...
        const result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Result$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].create({
            testId,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__877e7785._.js.map